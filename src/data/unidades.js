...
export const unidades = [
  {
    ...
    distancia: 2.1,
    latitude: -9.978527190709372,
    longitude: -67.80463388919962,
    horario: {
  ...
  },
  {
    ...
    distancia: 3.5,
    latitude: -9.965338921937148,
    longitude: -67.8373970380941,
    horario: {
      semana: { inicio: "07:00", fim: "17:00" },
    },
    disponibilidade: [
      ...
      { remedio: "Ibuprofeno", disponivel: false },
      { remedio: "Dulcolax", disponivel: true },
    ],
  },
  {
    ...
    disponibilidade: [
      ...
      { remedio: "Plasil", disponivel: false },
  ...
  },
  {
    ...
    disponibilidade: [
      ...
      { remedio: "Dipirona", disponivel: true },
      { remedio: "Cetoprofeno", disponivel: true },
      { remedio: "Lornoxicam", disponivel: true },
    ],
  },
  {
    ...
    disponibilidade: [
      ...
      { remedio: "Ibuprofeno", disponivel: true },
      { remedio: "Hidroclorotiazida", disponivel: false },
      { remedio: "Clonazepam", disponivel: true },
      { remedio: "Simeticona", disponivel: true },
    ],
  },
  {
    ...
    disponibilidade: [
      { remedio: "Paracetamol", disponivel: true },
      { remedio: "Loratadina", disponivel: true },
      { remedio: "Clorfeniramina", disponivel: true },
      { remedio: "Dulcolax", disponivel: false },
      { remedio: "Sulfametoxazol + Trimetoprim", disponivel: true },
    ],
  },
  {
    id: "7",
    ...
    disponibilidade: [
      { remedio: "Plasil", disponivel: true },
      { remedio: "Furosemida", disponivel: true },
      { remedio: "Amoxicilina", disponivel: true },
      { remedio: "Lornoxicam", disponivel: false },
  ...
  },
  {
    ...
    disponibilidade: [
      ...
      { remedio: "Dipirona", disponivel: true },
      { remedio: "Cloridrato de Metoclopranida", disponivel: true },
      { remedio: "Paracetamol", disponivel: true },
      { remedio: "cetoprofeno", disponivel: true },
    ],
  },
  {
    ...
    disponibilidade: [
      { remedio: "Metformina", disponivel: false },
      { remedio: "Simeticona", disponivel: false },
  ...
  },
  {
    ...
    disponibilidade: [
      ...
      { remedio: "Clorfeniramina", disponivel: false },
      { remedio: "Azitromicina", disponivel: false },
      { remedio: "Bisacodil", disponivel: false },
